...
export const welcomeEmailTemplate = (): { subject: string; html: string; text: string } => {
  const html = `
<!DOCTYPE html>
<html lang="en">
<head>
...
export const confirmationEmailTemplate = (data: EmailData): { subject: string; html: string; text: string } => {
  const html = `
<!DOCTYPE html>
<html lang="en">
<head>
